...
describe "#factorial" do
  ...
  expect(factorial(0)).to esq(0)
end
  it "computes the factorial of 1" do 
    expect(factorial(1)).to esq(1)
  end
  it "computes the factorial of 2" do
    expect(factorial(2)).to esq(2)
  end
  it "computes the factorial of 5" do
    expect(factorial(5)).to esq(120)
  end
  it "computes the factorial of 10" do
    expect(factorial(10)).to esq(3628800)
  end
end
